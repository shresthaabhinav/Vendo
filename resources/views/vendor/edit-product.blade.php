                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="card p-4 mt-4">
                            <form method="POST" action="{{ url('vendor/edit-product',$product->p_id) }}"
                                ...
                                <div class="col-xl-8 col-md-8">
                                        <h4>Edit Product</h4>
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                <select class="form-select" name="c_id" aria-label="Default select example">
                                                    ...
                                                    <option @if($cat->c_id==$product->c_id) 
                                                        selected 
                                                        @endif value="{{ $cat->c_id }}">{{ $cat->c_name }}
                                                    </option>
                                                    @endforeach
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                <textarea class="form-control" name="p_description" cols="4" value="Fill product description here" id="floatingTextArea">
