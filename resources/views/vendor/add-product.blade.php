                            ...
                            <div class="col-xl-8 col-md-8">
                                    <h4>Add Product</h4>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Rs 49999">
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <textarea class="form-control" cols="4" placeholder="Fill product description here" id="floatingTextArea"></textarea>
                                        </div>
