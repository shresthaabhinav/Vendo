                            ...
                            <div class="col-xl-8 col-md-8">
                                    <h4>Add Product</h4>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input type="text" name="p_price" class="form-control" placeholder="Rs 49999">
                                            @error('p_price')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_stock" placeholder="25 pcs">
                                            @error('p_stock')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="p_description" cols="4" placeholder="Fill product description here" id="floatingTextArea"></textarea>
                                            @error('p_description')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
