                                ...
                                <form method="POST" action="{{ url('vendor/login') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input value="{{ old('phone') }}" type="tel" name="phone" class="form-control" placeholder="977">
                                            @error("phone")
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary text-light form-control form-control-lg">Login</button>
