                    ...
                    <div class="container-fluid px-5">
                        <div class="row my-5">
                            ...
                            <div class="col-xl-6 col-md-6 mt-3 border border-primary p-3">
                                    ...
                                    <span class="text-dark"><strong>Name:</strong> Abhinav Shrestha</span><br>
                                    <span class="text-dark"><strong>Email:</strong> shrestha@gmail.com</span><br>
                                    <span class="text-dark"><strong>Phone:</strong> +977 9863482258</span><br>
                                    <span class="text-dark"><strong>Shipping Address:</strong>Dallu</span><br>
                            ...
                            <div class="col-xl-6 col-md-6 mt-3 border border-primary p-3">
                                    ...
                                    <span class="text-dark"><strong>Subtotal:</strong> Rs 1499.00</span><br>
                                    <h5 class="text-dark mt-3">Total: Rs 1499.00</h5>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa-solid fa-truck"></i></a>
                                                ...
                                                <a href="{{ ('order-detail') }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-ban"></i></a>
